...
let changecolor = (x) => {
    ...
    for (i = 0; i < yviteliujra.length; i++) {
        ...
        if (yviteliujra[i].style.backgroundColor == "rgb(250, 199, 72)" || yviteliujra[i].style.backgroundColor == "rgb(255, 31, 9)") {
            ...
            console.log(yviteliujrainner);
            let yviteliujrainnermoqmedeba = yviteliujrainner.includes("*");
            let moqmedeba;
            if (yviteliujrainner.includes("*")) {
                moqmedeba = "*";
            }
            else if (yviteliujrainner.includes("-")) {
                moqmedeba = "-";
            }
            console.log(yviteliujrainnermoqmedeba, moqmedeba);
            ...
            switch (moqmedeba) {
                case "*":
                    ...
                    console.log(answer);
                break;
                default: "Something's wrong here";
            }
